...
public class Level3Simulation : MonoBehaviour
{
    ...
    string path = "Assets/CSV/timeStepsL3.csv";
    StreamWriter writer;
    string pathDMG = "Assets/CSV/DamageDealtL3.csv";
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (printOneTime)
            {
                ...
                String scorePath = "Assets/CSV/Level3Score.csv";
    ...
    public void doCharacterActions()
    {
        ...
        //Takes 1/100 of the damage dealt by party and deals it to the tank
        dmg2Tank = dmgByParty / 100;
        dmg2Tank = Math.Round(dmg2Tank);
        warriorScript.takeDamage((int)dmg2Tank);
        wHealth.text = "Warrior: " + warriorScript.getHealth().ToString();
